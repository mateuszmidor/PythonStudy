...
class BuySellPairPLNQuotator:
    ...
    def quote(self, item: BuySellPair) -> BuySellPairPLN:
        ...
        quoted = BuySellPairPLN.from_taxable_item(
            item, buy_quotation_date, buy_paid_pln, buy_commission_pln, sell_quotation_date, sell_received_pln, sell_commission_pln
        )
        return quoted
